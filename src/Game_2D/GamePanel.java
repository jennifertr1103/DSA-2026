...
public class GamePanel extends JPanel implements Runnable {
    ...
    public boolean multiplayer = true;  // true = 2 players, false = vs bots
    ...
    public void update() {
        if (gameState == GameState.MENU) {
            if (keyH.enterPressed) {  // SỬA: cả hai đều có thể start
                keyH.consumeEnterKey();
                keyH2.consumeBombKey(); // Dùng để consume Enter của P2
    ...
    private void drawHUD(Graphics2D g2) {
        ...
        if (multiplayer && player2 != null) {
            ...
            // Bots (none in multiplayer mode)
            String mode = "2 PLAYER MODE";
